---
title: "macro factors 2 with MSRP and WPU10_Price_Index"
...
data_3 <- subset(data_2, select = c("DATE", "Average_MSRP_spec", "WPU10_Price_Index"))
...
# Fit a linear model
lin_model <- tslm(Average_MSRP_spec ~ WPU10_Price_Index)
summary(lin_model)
...
Average_MSRP_spec <- train_ts
exogenous <- train_df[, c("WPU10_Price_Index")]
...
xreg_vars <- test_df[, c("WPU10_Price_Index")]
...
ggplot(data_forecast_lin, aes(Time)) +
  ...
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Linear model with WPU10_Price_Index")
```
...
ggplot(data_forecast_ARIMAX, aes(Time)) +
  ...
  labs(x = "Time", y = "Average_MSRP_spec") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for ARIMAX model with WPU10_Price_Index")
```
...
ggplot(data_forecast_VAR, aes(Time)) +
  ...
  labs(x = "Time", y = "Average_MSRP_spec") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for VAR model with WPU10_Price_Index")
```
...
# set.seed(seedNum)
# fit.enet <- train(Average_MSRP_spec~., data=train_df["WPU10_Price_Index"], method="enet", metric="RMSE", trControl=control)
# print(fit.enet)
# summary(fit.enet)
...
ggplot(data_forecast_lin, aes(Time)) +
  ...
  ggtitle("18 Month Forecast vs. Actual Values for Linear model with WPU10_Price_Index")
```
...
ggplot(data_forecast_ARIMAX, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 12)) +
  ggtitle("18 Month Forecast vs. Actual Values for ARIMAX model with WPU10_Price_Index")
```
...
ggplot(data_forecast_VAR, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 12)) +
  ggtitle("18 Month Forecast vs. Actual Values for VAR model with WPU10_Price_Index")
```
...
#   scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
#   theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Ridge Regression model with WPU10_Price_Index")
```
...
#   labs(x = "Time", y = "Average MSRP") +
#   scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
#   theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Lasso Regression model with WPU10_Price_Index")
```
...
#   labs(x = "Time", y = "Average MSRP") +
#   scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
#   theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for ElasticNet Regression model with WPU10_Price_Index")
```
...
ggplot(data_forecast_cart2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Decision Tree - CART model with WPU10_Price_Index")
```
...
ggplot(data_forecast_bagcart2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Bagged CART model with WPU10_Price_Index")
```
...
ggplot(data_forecast_rf2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Random Forest model with WPU10_Price_Index")
```
...
ggplot(data_forecast_gbm2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("18 Month Forecast vs. Actual Values for Gradient Boosting model with WPU10_Price_Index")
```
