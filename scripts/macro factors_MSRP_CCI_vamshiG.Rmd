---
title: "macro factors 1 with MSRP and CCI"
...
data_3 <- subset(data_2, select = c("DATE", "Average_MSRP_spec", "CCI"))
...
# Fit a linear model
lin_model <- tslm(Average_MSRP_spec ~ CCI)
summary(lin_model)
...
ggplot(data_forecast_lin, aes(Time)) +
  ...
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Linear model with CCI")
```
...
ggplot(data_forecast_ARIMAX, aes(Time)) +
  ...
  labs(x = "Time", y = "Average_MSRP_spec") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for ARIMAX model with CCI")
```
...
ggplot(data_forecast_VAR, aes(Time)) +
  ...
  labs(x = "Time", y = "Average_MSRP_spec") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for VAR model with CCI")
```

```{r Q27}
# Accuracy for 12 Month - VAR model
...
# set.seed(seedNum)
# fit.enet <- train(Average_MSRP_spec~., data=train_df["CCI"], method="enet", metric="RMSE", trControl=control)
# print(fit.enet)
# summary(fit.enet)
...
# Make point predictions using the trained model on the test data
point_predictions <- predict(fit.cart, newdata = test_df)

# Get the estimated standard error of the residuals
residuals <- test_df$Average_MSRP_spec - point_predictions
sigma_hat <- sqrt(sum(residuals^2) / (n - length(fit.cart$finalModel$lambda)))
...
#   scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
#   theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Ridge Regression model with CCI")
```
...
#   labs(x = "Time", y = "Average MSRP") +
#   scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
#   theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Lasso Regression model with CCI")
```
...
#   labs(x = "Time", y = "Average MSRP") +
#   scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
#   theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for ElasticNet Regression model with CCI")
```
...
ggplot(data_forecast_cart2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Decision Tree - CART model with CCI")
```
...
ggplot(data_forecast_bagcart2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Bagged CART model with CCI")
```
...
ggplot(data_forecast_rf2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Random Forest model with CCI")
```
...
ggplot(data_forecast_gbm2, aes(Time)) +
  ...
  labs(x = "Time", y = "Average MSRP") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Gradient Boosting model with CCI")
```
