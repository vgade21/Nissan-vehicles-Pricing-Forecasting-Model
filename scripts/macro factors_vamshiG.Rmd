...
# 
# # Create the test dataframe (July 2020 to June 2021) - 18 months
...
# Fit a linear model
lin_model <- tslm(Average_MSRP_spec ~ CCI + GDP + Metal + Inflation)
summary(lin_model)
...
Average_MSRP_spec <- train_ts
exogenous <- train_df[, c("CCI", "GDP", "Metal", "Inflation")]
...
xreg_vars <- test_df[, c("CCI", "GDP", "Metal", "Inflation")]
...
ggplot(data_forecast_lin, aes(Time)) +
  ...
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for Linear model with Macro Factors")
```
...
ggplot(data_forecast_ARIMAX, aes(Time)) +
  ...
  labs(x = "Time", y = "Average_MSRP_spec") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for ARIMAX model with Macro Factors")
```
...
ggplot(data_forecast_VAR, aes(Time)) +
  ...
  labs(x = "Time", y = "Average_MSRP_spec") +
  scale_color_manual(values = c(Actual = "red", Forecasted = "blue")) +
  theme_minimal() + ggtitle("12 Month Forecast vs. Actual Values for VAR model with Macro Factors")
```
...
ggplot(data_forecast_lasso2, aes(Time)) +
  ...
  ggtitle("12 Month Forecast vs. Actual Values for Lasso Regression model with Macro Factors")
```
...
ggplot(data_forecast_ridge2, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 13)) +
  ggtitle("12 Month Forecast vs. Actual Values for Ridge Regression model with Macro Factors")
```
...
ggplot(data_forecast_enet2, aes(Time)) +
  ...
  ggtitle("12 Month Forecast vs. Actual Values for ElasticNet Regression model with Macro Factors")
```
...
ggplot(data_forecast_cart2, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 12)) +
  ggtitle("12 Month Forecast vs. Actual Values for Decision Tree - CART model with Macro Factors")
```
...
ggplot(data_forecast_bagcart2, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 13)) +
  ggtitle("12 Month Forecast vs. Actual Values for Bagged CART model with Macro Factors")
```
...
ggplot(data_forecast_rf2, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 13)) +
  ggtitle("12 Month Forecast vs. Actual Values for Random Forest model with Macro Factors")
```
...
ggplot(data_forecast_gbm2, aes(Time)) +
  ...
  theme_minimal() + 
  theme(plot.title = element_text(size = 13)) +
  ggtitle("12 Month Forecast vs. Actual Values for Gradient Boosting model with Macro Factors")
```
